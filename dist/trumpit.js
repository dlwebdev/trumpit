...
function isTrumped(s) {
    ...
    const phrases = ["great again", "build a wall", "China", "a lot of people are saying", "believe me"];
...
function trumpIt(s) {
    ...
    const trumpit_phrases = [" and make it great again", " and build a wall", " . A lot of people are saying..", " and grab her by the pussy", ", a lot of people are saying", ", so sad.", " Covfefe.", ", Chinnnnaaaa", " and you're pathetic", ", and you're a loser."];
